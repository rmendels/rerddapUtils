...
which does lazy access to the contents of the folder.  To actual get the data an action must be initiated, such as the following will read the entire download into memory:
